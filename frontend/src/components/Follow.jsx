...
export const Follow = () => {
  return (
    <div className="relative flex flex-col min-h-screen items-start justify-start bg-black bg-clip-content">
      ...
      <div className="flex flex-col w-full h-auto mx-2 my-2 bg-black rounded-lg border border-gray-700 shadow-xl items-start justify-between p-4">
        ...
        <div className="flex items-start justify-start py-2 px-2">
          <Link className="flex items-center jsutify-center">
            ...
            <small className="mx-2 text-gray-50 text-md font-normal">1</small>
          </Link>
        </div>
      </div>
    </div>
